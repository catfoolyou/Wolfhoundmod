...
namespace wolfhoundmod.Projectiles
{
	public class muzzleflash : ModProjectile
	{
		...
		public override void AI() {
			...
			aiType = ProjectileID.LaserMachinegun;*/
			...
			if (!projOwner.frozen) {
				...
				/*if (projOwner.itemAnimation < projOwner.itemAnimationMax) // Somewhere along the item animation, make sure the spear moves back
				{
					movementFactor -= 0f;
				}
